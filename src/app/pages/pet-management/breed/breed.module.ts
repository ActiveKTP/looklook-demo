...
import { BreedListingComponent } from './breed-listing/breed-listing.component';
import { BreedDetailsComponent } from './breed-details/breed-details.component';



@NgModule({
  declarations: [BreedListingComponent, BreedDetailsComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    RouterModule.forChild([
      {
        path: '',
        component: BreedListingComponent,
      },
      {
        path: ':id',
